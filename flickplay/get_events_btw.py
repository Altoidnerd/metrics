...
'''
Get all devents between two datestamp values.

Use it to push the latest events to the sql db from mixpanel's mysterious document storage.
'''
...
outdir = 'data'
i_date = datetime.date(2022,12,15)
dt = datetime.timedelta(days=1)
