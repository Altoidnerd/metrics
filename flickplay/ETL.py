...
from os.path import abspath, isdir, isfile, join, mkdir
...
# def collect_mixpanel_csvs(outdir=None):
#     if outdir is None:
#           outdir = 'data'
#     if not os.isdir(outdir):
#           os.mkdir(outdir)
...
#     ifinal = len(infiles)//2

#     for inf in infiles[0:ifinal]:
#         dfs.append(pd.read_csv(inf))
